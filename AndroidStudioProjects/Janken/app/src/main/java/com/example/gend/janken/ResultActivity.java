package com.example.gend.janken;
...
public class ResultActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ImageView myHandImageView = (ImageView) findViewById(R.id.my_hend_image);
        switch(id){
            case R.id.gu:
        ...
        int comHAND = getHand();
        ImageView comHandImageView = (ImageView) findViewById(R.id.com_hend_image);
        switch (comHAND) {
            case JANKEN_GU:
        ...
        seveData(myHand, comHAND,gameResult);
    }
    public void onBackButtonTapped(View view){
        finish();
    }
    private void seveData(int myHand, int comHand, int gameResult){
        ...
        if(lastGameResult == 2 && gameResult == 1) {
        ...
        editor.putInt("GAMECOUNT",gameResult);
