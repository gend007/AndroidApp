...
public class MYUtils {
    ...
    //URIを指定したビットマップの取得メソッド
    public static Bitmap getTmageFromStream(ContentResolver resolver, Uri uri)
        throws IOException{
        InputStream in;
        BitmapFactory.Options opt = new BitmapFactory.Options();
        opt.inJustDecodeBounds = true;
    ...
    public static void tintMenuIcon(Context context, MenuItem item,
        ...
        Drawable wrapDrawable = DrawableCompat.wrap(normalDrawble);
