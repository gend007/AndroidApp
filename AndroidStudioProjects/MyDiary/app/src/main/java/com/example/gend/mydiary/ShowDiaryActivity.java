...
public class ShowDiaryActivity extends AppCompatActivity {
    public static final String DIARY_ID = "DAIARY_ID";
    private static final long ERR_ID = -1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final long diaryId = intent.getLongExtra(DIARY_ID, ERR_ID);
        ...
        //データベースから日記ID取得処理
        Diary diary = mRealm.where(Diary.class).equalTo("id", diaryId).
                findFirst();
        ...
        if (bytes != null && bytes.length > 0){
            ...
            //paletteクラスを使用し画像から代表色を取得し画面デザインへ反映する処理
